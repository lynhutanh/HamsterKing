...
const MainContentProductToyPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch('https://apis-1d85.onrender.com/product/get-product-of-type/do-choi');
...
export default MainContentProductToyPage;
