...
const MainContentProductHamsterPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch('https://apis-1d85.onrender.com/product/get-product-of-type/hamster');
...
export default MainContentProductHamsterPage;
